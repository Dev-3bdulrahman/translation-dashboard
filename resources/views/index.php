...
<div class="container-fluid">
    ...
    <p>
        ...
        <form class="form-import" method="POST" action="<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@postImport'); ?>" data-remote="true" role="form">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                    <button type="submit" class="btn btn-success btn-block"  data-disable-with="Loading.."><i class="fas fa-file-import me-2"></i> Import groups</button>
                    </div>
                </div>
            </div>
        </form>
        <form class="form-find" method="POST" action="<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@postFind'); ?>" data-remote="true" role="form" data-confirm="Are you sure you want to scan you app folder? All found translation keys will be added to the database.">
            <div class="form-group">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <button type="submit" class="btn btn-info" data-disable-with="Searching.." ><i class="fas fa-search me-2"></i> Find translations in files</button>
            </div>
        </form>
        <?php } ?>
        <?php if (isset($group)) { ?>
            <form class="form-inline form-publish" method="POST" action="<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@postPublish', $group); ?>" data-remote="true" role="form" data-confirm="Are you sure you want to publish the translations group '<?php echo $group; ?>? This will overwrite existing language files.">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <button type="submit" class="btn btn-info" data-disable-with="Publishing.." ><i class="fas fa-upload me-2"></i> Publish translations</button>
                <a href="<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@getIndex'); ?>" class="btn btn-default"><i class="fas fa-arrow-left me-2"></i> Back</a>
            </form>
        <?php } ?>
    </p>
    <form role="form" method="POST" action="<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@postAddGroup'); ?>">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary" name="add-group"><i class="fas fa-plus me-2"></i> Add and edit keys</button>
        </div>
    </form>
    <?php if ($group) { ?>
        <form action="<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@postAdd', [$group]); ?>" method="POST"  role="form">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary"><i class="fas fa-plus me-2"></i> Add keys</button>
            </div>
        </form>
        <div class="row">
            <div class="col-sm-2">
                <button class="btn btn-info enable-auto-translate-group"><i class="fas fa-language me-2"></i> Use Auto Translate</button>
            </div>
        </div>
