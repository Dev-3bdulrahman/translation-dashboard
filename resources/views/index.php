...
<head>
    ...
    <!-- Bootstrap 5 CSS -->
    <link href="<?php echo asset('vendor/translation-dashboard/css/bootstrap.min.css'); ?>" rel="stylesheet">
    <!-- Font Awesome for icons -->
    <link rel="stylesheet" href="<?php echo asset('vendor/translation-dashboard/css/font-awesome.min.css'); ?>">
    <!-- jQuery -->
    <script src="<?php echo asset('vendor/translation-dashboard/js/jquery-3.6.0.min.js'); ?>"></script>
    <!-- Bootstrap 5 JS Bundle with Popper -->
    <script src="<?php echo asset('vendor/translation-dashboard/js/bootstrap.bundle.min.js'); ?>"></script>
    <!-- X-editable -->
    <link href="<?php echo asset('vendor/translation-dashboard/css/bootstrap-editable.min.css'); ?>" rel="stylesheet">
    <script src="<?php echo asset('vendor/translation-dashboard/js/bootstrap-editable.min.js'); ?>"></script>
    <!-- jQuery Cookie -->
    <script src="<?php echo asset('vendor/translation-dashboard/js/jquery.cookie.min.js'); ?>"></script>
    <!-- jQuery Visible Plugin -->
    <script src="<?php echo asset('vendor/translation-dashboard/js/jquery.visible.min.js'); ?>"></script>
    <!-- Animation library -->
    <link href="<?php echo asset('vendor/translation-dashboard/css/animate.min.css'); ?>" rel="stylesheet">
    <!-- jQuery UJS -->
    <script src="<?php echo asset('vendor/translation-dashboard/js/jquery-ujs.min.js'); ?>"></script>
    <style>
        :root {
    ...
    <script>
        jQuery(document).ready(function($){
            ...
            // Ensure the group select change event is properly bound
            $(document).on('change', '.group-select', function() {
                var group = $(this).val();
                console.log("Group selected (document event):", group);
                if (group) {
                    window.location.href = '<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@getView'); ?>/'+group;
                } else {
                    window.location.href = '<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@getIndex'); ?>';
...
<div class="container-fluid">
    ...
    <p>
        <?php if (!isset($group)) { ?>
            <div class="row">
        <form class="form-import col-6" method="POST" action="<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@postImport'); ?>" data-remote="true" role="form">
        ...
        <form class="form-find col-6" method="POST" action="<?php echo action('\Dev3bdulrahman\TranslationDashboard\Controller@postFind'); ?>" data-remote="true" role="form" data-confirm="Are you sure you want to scan you app folder? All found translation keys will be added to the database.">
            <div class="card mb-4 animate__animated animate__fadeIn">
